...
class UpdateParticipantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $category = $participant instanceof Participant ? $participant->category : null;
        ...
        return [
            ...
            'parent_name' => [
                'nullable',
                Rule::when(
                    in_array($category, [ParticipantCategory::Toddler, ParticipantCategory::Teenager], true),
    ...
    public function messages(): array
    {
        return [
            ...
            // Kategori Khusus
            'parent_name.required' => 'Nama orang tua/wali wajib diisi untuk kategori ini.',
            'husband_name.required' => 'Nama suami wajib diisi untuk kategori ibu hamil.',
