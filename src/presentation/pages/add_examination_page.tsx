...
export function AddExaminationPage() {
  ...
  // Dynamic page title
  useDocumentTitle(
    selectedPeserta ? `${selectedPeserta.nama}` : "Pemeriksaan",
  );
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return <Step1Verifikasi peserta={selectedPeserta} />;
      case 2:
        return (
          <Step2Pemeriksaan
      ...
      case 3:
        return (
          <Step3WaktuLokasi formData={formData} onChange={handleFormChange} />
        );
      case 4:
        return (
          <Step4Konfirmasi peserta={selectedPeserta} formData={formData} />
        );
      default:
        return null;
    }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex items-center justify-between mb-8">
        ...
        <nav className="hidden md:flex items-center gap-2 text-sm text-gray-400">
          ...
          <span className="text-gray-900">Buat Pemeriksaan</span>
        </nav>
      </div>
        ...
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              {currentStep === 1 &&
                "Pastikan data identitas peserta sudah sesuai"}
              {currentStep === 2 &&
                "Lengkapi hasil pemeriksaan kesehatan sesuai kategori"}
              {currentStep === 3 &&
                "Tentukan waktu, lokasi, dan status rujukan"}
              {currentStep === 4 &&
                "Periksa kembali semua data sebelum disimpan ke sistem"}
            </p>
          </div>
