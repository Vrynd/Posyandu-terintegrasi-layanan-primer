         ...
         <header className="bg-white/80 backdrop-blur-xl sticky top-0 z-50 shadow-sm ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
               <div className="flex items-center justify-between">
                  ...
                  >
                     <div className="w-12 h-12 rounded-xl bg-linear-to-br from-blue-600 to-indigo-600 text-white flex items-center justify-center">
                        <Stethoscope className="w-6 h-6" strokeWidth={2} />
                     </div>
                     <div>
                        <h1 className="text-lg font-bold text-gray-900">Posyandu Layanan Primer</h1>
                        <p className="text-[0.85rem] leading-tight font-normal text-gray-500">Desa Tondomulyo</p>
                     </div>
                  </div>
