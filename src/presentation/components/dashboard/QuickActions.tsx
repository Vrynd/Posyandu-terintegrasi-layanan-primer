          ...
          {actions.map((action) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-10 h-10 rounded-xl bg-linear-to-br ${action.bgGradient} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300 ${
                ...
                <p
                  className={`font-semibold text-sm mb-1 ${
                    action.comingSoon ? "text-gray-600" : "text-gray-900"
                  }`}
                >
                  {action.label}
                </p>
